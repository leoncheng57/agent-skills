<!-- VENDORED, MIT. Source: mattpocock/skills
     skills/productivity/writing-for-agents/SKILL.md @ 0ab1b63a410a03d3627979a109c8695de27af954
     Frontmatter stripped: this is a reference document for the `skill-smith`
     skill, not a skill in its own right. See CREDITS.md at the repo root. -->

# Writing for agents

Reference for writing any document an agent consumes: a skill, an `AGENTS.md` / `CLAUDE.md`, a doc reached by a pointer. The packaging differs; the writing does not: the same levers make each one predictable, since the agent takes the same _process_ every run rather than producing the same output.

When the document you're writing is a skill, read [`writing-for-agents-mechanics.md`](writing-for-agents-mechanics.md) for frontmatter, invocation choice, and router skills.
...
- **By invocation**, skill-specific: see [`writing-for-agents-mechanics.md`](writing-for-agents-mechanics.md).
